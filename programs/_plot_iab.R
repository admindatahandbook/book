...
iabt1data <- data.frame(
  Items = c("Population / Sample Size", 
            ...
            "Additional information"),
  Features = c(
    "2% random sample (more than 1.8 million individuals) of the Integrated Employment Biographies, a database which includes records from<br>
...
2007 onwards: Registered jobseeker",
    ...
    Stratified sample of all establishments with at least one employee liable to social security on June 30 of the year before by establishment size, industry, and federal state. There are two versions of LIAB:<br>
