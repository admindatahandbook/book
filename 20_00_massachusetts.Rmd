# Case Study: Evaluating a Rental Assistance Program in Massachusetts {#massachusetts}
...
through emergency shelters each year [@binder2019].[^massachusetts1] Each year, significant US
...
built into the program from the beginning (for instance, the [Learn to
Earn Initiative](https://www.mass.gov/service-details/learn-to-earn-initiative) [@mass.gova], in
...
[^massachusetts2]: @mass.govb [[https://www.mass.gov/info-details/emergency-housing-assistance-during-covid-19]{.underline}](https://www.mass.gov/info-details/emergency-housing-assistance-during-covid-19).
...
[^massachusetts3]: See @heard2017 Heard et al. (2017, p. 12) for a definition and discussion of
...
[^massachusetts4]: Because participants in both groups can enroll in RAFT, conducting
    ...
    considerations for encouragement designs are discussed in @heard2017 Heard et
    al. (2017), and  @doylefeeney2021 provide a guide to power calculations.
