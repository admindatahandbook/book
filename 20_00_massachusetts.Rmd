# Case Study: Evaluating a Rental Assistance Program {#massachusetts}
...
through emergency shelters each year.[^massachusetts1] Each year, significant US
...
preserve current housing or move to new housing.[^massachusetts2] Researchers at the
...
with the state (including two ongoing projects that J-PAL North America
[has](https://www.povertyactionlab.org/evaluation/impact-text-message-nudges-churn-supplemental-nutrition-assistance-program-united-states)
or [is
currently](https://www.empathways.org/direct-services/amp-up-boston)
supporting), and real but solvable challenges to using data for
research. Amanda Lee, a research manager at J-PAL North America,
...
Incubator](https://www.povertyactionlab.org/initiative/housing-stability-evaluation-incubator),
...
evaluation, and because administrative data access was a primary
...
designing the evaluation, if someone applied to RAFT and was eligible,
they received funds. That is, funding for the program was not a
...
encouragement mechanism, the research team decided to try and run a
...
sufficient statistical power.[^massachusetts4] As of October 2021, the pilot has not
...
the pilot. No DUAs have been signed as of October 2021, though the DTA's
...
built into the program from the beginning (e.g., [Learn to
Earn](https://www.mass.gov/service-details/learn-to-earn-initiative), in
which agencies stipulated what data they would share from the beginning
of the program). Specific DUAs were created across agencies to enable
this sharing of data specifically for this program. We explored whether
...
participants would be for this project.** In having discussions with
...
Harvard University's (where the researchers are based) IRB determined
...
Security
Policy](https://research.harvard.edu/2020/06/26/research-data-management/).
...
level](https://policy.security.harvard.edu/view-data-security-level);
...
Researchers have not yet gained access to data, and therefore the
...
[^massachusetts2]: [[https://www.mass.gov/info-details/emergency-housing-assistance-during-covid-19]{.underline}](https://www.mass.gov/info-details/emergency-housing-assistance-during-covid-19).
    During the pandemic, Massachusetts also operated the Emergency
    Rental Assistance Program, which provides up to 18 months of support
    for rent arrears and future rent stipends.

[^massachusetts3]: See Heard et al. (2017, p. 12) for a definition and discussion of
...
[^massachusetts4]: Because participants in both groups can enroll in RAFT, conducting
    ...
    considerations for encouragement designs are discussed in Heard et
    al. (2017), and a guide to power is available in this [[J-PAL
    Research
    Resource]{.underline}](https://www.povertyactionlab.org/resource/quick-guide-power-calculations).

[^massachusetts5]: <https://policy.security.harvard.edu/view-data-security-level>
