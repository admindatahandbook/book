...
radarplot <- function(data) { 
   data_long = data.frame(data$rank[1],data$rank[2],data$rank[3],data$rank[4],data$rank[5])
   colnames(data_long) <- c("Data Location", "Access Computer", "Analysis Computer", "Access Room", "Analysis Method")
   data_long <- rbind(4, 0, data_long)

   radarchart(data_long, axistype=1,
              
            #custom polygon
            pcol=rgb(0.1,0.5,0.6,0.9) , pfcol=rgb(0.1,0.5,0.6,0.5) , plwd=1 , 
