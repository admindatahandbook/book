...
| `r colorize("green","#33a02c")`|`r colorize("light blue","#a6cee3")`|("dark blue","#1f78b4")`|
|:---:|:---:|:---:|
...
> The German IAB Research Data Centers ("on-site access") house all highly confidential IAD data on their own servers, which are accessed remotely by researchers from various locations.
...
In some cases, the distinction between these two categories becomes blurred. A data provider with substantial expertise in making their own data accessible may offer this expertise to others, thus acting as third party data custodian.
