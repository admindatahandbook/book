...
> *Instructions:* Use this template to structure your contribution. Delete this line when you are done. We have drawn in part of generic guidelines provided by @OECDEXPERTGROUPINTERNATIONAL2014 and @DesaiFiveSafesdesigning2016 . All questions or guidance is optional, in the sense that you may not have a long answer, or no answer at all, or it may not be relevant for your scenario. However, if that is the case, we are interested in why it was not relevant, as that may itself be valuable information for others.

### Self-description
> *Instruction:* Describe the scenario that is covered by this case study. Who are you, and who is the data provider, who are the data users. 

### Motivation
> *Instructions:* Describe WHY you are making data available. Whereas the next section will discuss your legal ability to provide access to the data, this section is meant to allow you to describe the motivation of your entity (business, company, government) to provide access to data that otherwise would not be available. What are the outcomes that benefit you, or the performance metrics that matter to you? Do you need to capture or document a benefit to permit data access? 
...
### Outreach
> *Instructions:* how do [Safe People](researchers) become aware of your access point and data offerings?
...
#### Disposal of data
> *Instructions:* do you delete data files or purge records within the data due to legal requirements or limited resources to maintain? Do  purge records upon request or at certain time intervals (eg juvenile justice, deleted tweets)?How do you handle that?
