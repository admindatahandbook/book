...
### Summary
> *Instructions:* Describe the scenario that is covered by this case study. Introduce the authors, the data provider, data collectors, data curators, and interesting uses of the data. 
