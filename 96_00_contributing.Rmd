...
pandoc_convert(file.path(here(),"assets/contributing/case_study_template.md"),
  to="html5",
  output=file.path(here(),"assets/contributing/case_study_template.pdf"))
