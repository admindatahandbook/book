...
cat("\\input{./assets/pcri/pcrifigurea1.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
cat("\\input{./assets/pcri/pcritablea1.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
cat("\\input{./assets/pcri/pcritablea2.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
cat("\\input{./assets/pcri/pcrifigurea2.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
cat("\\input{./assets/pcri/pcrifigurea3.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
cat("\\input{./assets/pcri/pcritablea3.tex}")
}
```
