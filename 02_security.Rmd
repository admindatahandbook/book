...
if ( knitr::is_latex_output() ) {
  cat("\\input{./assets/security/securitytable1.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
  cat("\\input{./assets/security/securitytable2.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
  cat("\\input{./assets/security/securitytable3.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
  cat("\\input{./assets/security/securitytable4.tex}")
}
```
...
if ( knitr::is_latex_output() ) {
  cat("\\input{./assets/security/securitytable5.tex}")
}
```
...
```{r, nbirdtplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, iabrdcplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, iabjosuaplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, iabsufplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, oldaplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, pcriplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, fsrdcplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, rtraplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, spnplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, ncesplot, echo=FALSE, fig.width=3, fig.height=2,out.extra='style="float:left; padding:10px"',eval=knitr::is_html_output()}
...
```{r, summarytable, echo=F, fig.cap="Summary of Access Mechanisms Along the Five Aspects",results='asis'}
